...
namespace SerializedItem
{
	...
	public class SerializedItemForm : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.WindowControl.ImagePart = new System.Drawing.Rectangle(0, 0, 652, 494);
			...
			this.CopyrightLabel.Text = "© 2014 MVTec Software GmbH";
		...
		private void CreateBtn_Click(object sender, System.EventArgs e)
		{
			...
			for (int i = 0; i < 4; i++)
			{
				...
				Window.SetWindowExtents(0, 0, Width - 1, Height - 1);
		...
		private void Action()
		{
			...
			HXLDCont ContoursAffinTrans = ModelContours.AffineTransContourXld(HomMat2D);

			HSystem.SetSystem("flush_graphic", "false");
			Window.DispObj(Img);
			HSystem.SetSystem("flush_graphic", "true");
			Window.DispObj(ContoursAffinTrans);
